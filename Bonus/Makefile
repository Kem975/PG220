all: clean
	...
	javac -d build -cp build src/game_components/players/IAHighestBid.java
	javac -d build -cp build src/game_components/players/IARandom.java
	javac -d build -cp build src/game_components/Log.java
	javac -d build -cp build src/game_components/graphic_display/states/*.java src/game_components/graphic_display/*.java src/game_components/Game.java src/game_components/players/Human.java
